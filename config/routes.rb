Rails.application.routes.draw do
  ...
  post 'forgot', controller: 'users', action: 'forgot_notification'
  ...
  get 'invite/:token', controller: 'users', action: 'invite'
  patch 'invite/:token', controller: 'users', action: 'do_invite'
